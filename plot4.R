...
par(mfcol = c(2, 2))
plot(x = epc_data$DT, y = epc_data$Global_active_power, type = "l"
...
plot(x = epc_data$DT, y = epc_data$Voltage, type = "l"
     ,xlab = "datetime", ylab = "Voltage")
plot(x = epc_data$DT, y = epc_data$Global_reactive_power, type = "l"
